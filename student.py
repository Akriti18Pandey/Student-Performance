...
st.markdown(
    "<div class='subtitle'>Predict Whether a Student Will Pass or Fail</div>",
    unsafe_allow_html=True
)
...
# ==================================================
# SELECT ONLY FEATURES USED IN DASHBOARD
# ==================================================
...
with c1:
    ...
    <div class='card'>
    <h3>📖 Study Time</h3>
    Higher study time usually improves academic performance.
    </div>
    """, unsafe_allow_html=True)
...
with c2:
    ...
    <div class='card'>
    <h3>📅 Attendance</h3>
    Fewer absences generally lead to better grades.
    </div>
    """, unsafe_allow_html=True)
...
with c3:
    ...
    Previous failures strongly influence future results.
    </div>
    """, unsafe_allow_html=True)
